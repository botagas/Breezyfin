...
export const useSettingsDisclosures = () => {
	...
	return {
		...
		assSubtitleRendererPopupOpen: disclosures[SETTINGS_DISCLOSURE_KEYS.ASS_SUBTITLE_RENDERER] === true,
		bitmapSubtitleRendererPopupOpen: disclosures[SETTINGS_DISCLOSURE_KEYS.BITMAP_SUBTITLE_RENDERER] === true,
		...
		subtitleOverlayOutlineSizePopupOpen: disclosures[SETTINGS_DISCLOSURE_KEYS.SUBTITLE_OVERLAY_OUTLINE_SIZE] === true,
		subtitleOverlayShadowDistancePopupOpen: disclosures[SETTINGS_DISCLOSURE_KEYS.SUBTITLE_OVERLAY_SHADOW_DISTANCE] === true,
		subtitleOverlayShadowAnglePopupOpen: disclosures[SETTINGS_DISCLOSURE_KEYS.SUBTITLE_OVERLAY_SHADOW_ANGLE] === true,
		navbarThemePopupOpen: disclosures[SETTINGS_DISCLOSURE_KEYS.NAVBAR_THEME] === true,
		screensaverTimeoutPopupOpen: disclosures[SETTINGS_DISCLOSURE_KEYS.SCREENSAVER_TIMEOUT] === true,
		...
		openAssSubtitleRendererPopup: disclosureHandlers[SETTINGS_DISCLOSURE_KEYS.ASS_SUBTITLE_RENDERER].open,
		closeAssSubtitleRendererPopup: disclosureHandlers[SETTINGS_DISCLOSURE_KEYS.ASS_SUBTITLE_RENDERER].close,
		openBitmapSubtitleRendererPopup: disclosureHandlers[SETTINGS_DISCLOSURE_KEYS.BITMAP_SUBTITLE_RENDERER].open,
		closeBitmapSubtitleRendererPopup: disclosureHandlers[SETTINGS_DISCLOSURE_KEYS.BITMAP_SUBTITLE_RENDERER].close,
		...
		openSubtitleOverlayOutlineSizePopup: disclosureHandlers[SETTINGS_DISCLOSURE_KEYS.SUBTITLE_OVERLAY_OUTLINE_SIZE].open,
		closeSubtitleOverlayOutlineSizePopup: disclosureHandlers[SETTINGS_DISCLOSURE_KEYS.SUBTITLE_OVERLAY_OUTLINE_SIZE].close,
		openSubtitleOverlayShadowDistancePopup: disclosureHandlers[SETTINGS_DISCLOSURE_KEYS.SUBTITLE_OVERLAY_SHADOW_DISTANCE].open,
		closeSubtitleOverlayShadowDistancePopup: disclosureHandlers[SETTINGS_DISCLOSURE_KEYS.SUBTITLE_OVERLAY_SHADOW_DISTANCE].close,
		openSubtitleOverlayShadowAnglePopup: disclosureHandlers[SETTINGS_DISCLOSURE_KEYS.SUBTITLE_OVERLAY_SHADOW_ANGLE].open,
		closeSubtitleOverlayShadowAnglePopup: disclosureHandlers[SETTINGS_DISCLOSURE_KEYS.SUBTITLE_OVERLAY_SHADOW_ANGLE].close,
		...
		openScreensaverTimeoutPopup: disclosureHandlers[SETTINGS_DISCLOSURE_KEYS.SCREENSAVER_TIMEOUT].open,
		closeScreensaverTimeoutPopup: disclosureHandlers[SETTINGS_DISCLOSURE_KEYS.SCREENSAVER_TIMEOUT].close,
